...
public class JwtTokenProvider {
    ...
    private final String secretKey = "WudZIfA9euSZhPNALoDNRhpPcbAsBOkyFaBkcYz1XRKsxRheRE/+YA==";
    ...
    public JwtToken generateToken(Authentication authentication, Map<String, Object> body) {
        ...
        log.info("generateToken getPrincipal(line44) :  {}", authentication.getPrincipal());
        log.info("generateToken getName(line45) : {}", authentication.getName());
        log.info("generateToken authentication(line46) : {}", authentication.toString());
